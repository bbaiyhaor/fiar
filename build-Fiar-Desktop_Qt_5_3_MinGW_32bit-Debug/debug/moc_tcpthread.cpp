...
QT_MOC_LITERAL(6, 72, 16)
    ...
    "TcpThread\0socketDisconnected\0\0error\0"
...
void TcpThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->socketDisconnected((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (TcpThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpThread::socketDisconnected)) {
                *result = 0;
            }
        }
        {
...
const QMetaObject TcpThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TcpThread.data,
      qt_meta_data_TcpThread,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void TcpThread::socketDisconnected(int _t1)
{
